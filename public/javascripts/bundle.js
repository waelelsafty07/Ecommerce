...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"api/quicklook.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Quicklook = void 0;
...
var config = function config(method, url) {
  var settings = {
    method: method,
    url: url
  };
...
var Quicklook = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id) {
    var url, settings, res;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            settings = config('get', url);
            console.log(settings);
            _context.next = 6;
            return (0, _axios.default)(settings);
          ...
          case 12:
            ...
            console.log(_context.t0); // showAlert('error', err.response.data.message);
  ...
  return function Quicklook(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.Quicklook = Quicklook;
},{"axios":"../../node_modules/axios/index.js"}],"api/categories.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js"}],"api/login.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.forgot = exports.logOut = exports.loginBuyer = void 0;
...
var config = function config(method, url, data) {
  var settings = {
    method: method,
    url: url,
    headers: {},
...
var loginBuyer = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            settings = config('POST', '/api/users/login', {
              email: email,
              password: password
            });
            _context.next = 4;
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            console.log(_context.t0.response.data.message); // showAlert('error', err.response.data.message);
  ...
  return function loginBuyer(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            settings = config('GET', '/api/v1/users/logout');
            _context2.next = 4;
            return (0, _axios.default)(settings);
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            settings = config('POST', '/api/v1/users/forgotPassword/', {
              email: email
            });
            _context3.next = 4;
            return (0, _axios.default)(settings);
...
},{"axios":"../../node_modules/axios/index.js"}],"api/profile.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.editeProfile = void 0;
...
var editeProfile = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = "/api/users/updateMyData";
            settings = config('patch', url, data); // console.log(settings);
          ...
          case 9:
            _context.prev = 9;
            _context.t0 = _context["catch"](0);
            console.log(_context.t0.response.data); //  showAlert('error', err.response.data);
  ...
  return function editeProfile(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.editeProfile = editeProfile;
...
var _quicklook = require("./api/quicklook");
...
if (addButton) {
  addButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var phone;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
if (changeButton) {
  changeButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var email;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
...
var editeUser = document.querySelector('.edit-profile');

if (editeUser) {
  editeUser.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
      var fname, lname, username, day, month, year, phone, email, gender, data;
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 18;
              return (0, _profile.editeProfile)(data);
...
var loginfrom = document.querySelector('.login-buyer-form');
...
if (loginfrom) {
  loginfrom.addEventListener('submit', function (e) {
    ...
    (0, _login.loginBuyer)(email, password);
  });
}
/**
...
var quickModel = document.querySelectorAll('.qiucker');

if (quickModel) {
  (function () {
    var quickArray = Array.from(quickModel);
    var name = document.querySelector('.pd-detail__name');
    var price = document.querySelector('.pd-detail__price');
    var discount = document.querySelector('.pd-detail__discount');
    var del = document.querySelector('.pd-detail__del');
    var reviewQunitiy = document.querySelector('.reviewQunitiy');
    var stock = document.querySelector('.pd-detail__stock');
    var description = document.querySelector('.pd-detail__preview-desc');
    var wishlist = document.querySelector('.pd-detail__click-count');
    var categories = document.querySelector('.categories');
    var breadname = document.querySelector('.breadname');

    var _loop = function _loop(i) {
      var response = void 0;
      quickArray[i].addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
        var id;
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                id = quickArray[i].getAttribute('data-product-id');
                console.log(id);
                _context4.next = 4;
                return (0, _quicklook.Quicklook)(id);
              ...
              case 4:
                ...
                if (response.singleProduct.priceDiscount) {
                  ...
                  price.textContent = "$".concat(response.singleProduct.price);
                  discount.textContent = '';
                  del.textContent = '';
                }

                reviewQunitiy.textContent = "(".concat(response.singleProduct.ratingsQuantity, ")");
                stock.textContent = "".concat(response.singleProduct.stock, " in stock");
                description.textContent = response.singleProduct.description;
                wishlist.textContent = " (".concat(response.singleProduct.wishlist, ")");
...
if (CategoryList) {
  var categoryList = document.getElementById('fetchCategories');
  (function () {
    var _get = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
      var response;
      return regeneratorRuntime.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return (0, _categories.getCategories)();

            case 2:
              response = _context5.sent;
              console.log(response.Categories);
              Array.from(response.Categories).forEach(function (category) {
